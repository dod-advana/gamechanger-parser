...
from policy_analytics_parser.text_utils import utf8_pass, clean_text
...
def post_process(doc_dict):
    ...
    if doc_dict["meta_data"]:
        ...
        doc_dict["access_timestamp_dt"] = get_access_timestamp(doc_dict["meta_data"])
        doc_dict["publication_date_dt"] = get_publication_date(doc_dict["meta_data"])
